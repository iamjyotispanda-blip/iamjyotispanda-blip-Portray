    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 text-white w-full max-w-lg">
          ...
          <p className="text-lg text-blue-100 leading-relaxed mb-12 text-justify">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <Ship className="text-orange-400 h-6 w-6" />
              <span className="text-blue-100">Real-time vessel tracking and scheduling</span>
            </div>
            <div className="flex items-center space-x-3">
              <Package className="text-orange-400 h-6 w-6" />
              <span className="text-blue-100">Comprehensive cargo management</span>
            </div>
            <div className="flex items-center space-x-3">
