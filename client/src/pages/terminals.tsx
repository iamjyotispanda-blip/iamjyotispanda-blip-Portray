                          ...
                          <div className="space-y-2">
                            <div className="flex items-center space-x-3">
                              ...
                              <div className="flex items-start justify-between">
                                ...
                                {/* Show activation details aligned to badge */}
                                {terminal.status === "Active" && terminal.activationStartDate && (
                                  <div className="flex flex-col space-y-1 text-sm text-gray-700 dark:text-gray-300 text-right">
                                    ...
                                    {terminal.activationEndDate && (
                                      <h5 className="text-lg font-bold text-green-700 dark:text-green-300 mt-1">
